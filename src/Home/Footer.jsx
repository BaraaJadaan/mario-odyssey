...
function Footer() {
  return (
    <div className=' bg-[#3B3B3B]'>
        <div className=' mx-28 mt-32 flex justify-evenly pt-8'>
            <div className=''>
                <div class="flex"> {/*banner*/}
                    ...
                    <div class="w-[12.46rem] h-[1.23rem] font-bold text-lg shadow-sm mb-5" >
                        <p class="font-mono text-white text-lg">NFT Marketplace</p>
                    </div>
                    
                </div>
                    <div className=' text-gray-300 text-xs font-semibold'>NFT marketplace UI created <br /> with Anima for Figma.</div>
                    <div className=' text-gray-300 text-xs font-semibold mt-4'>Join our community</div>
                    <div className=' flex gap-3 mt-4'>
                        <img  src={DiscordLogo} alt="" />
                        <img  src={YoutubeLogo} alt="" />
                        <img className='mt-1 ' src={TwitterLogo} alt="" />
                        <img src={InstagramLogo} alt="" />
                    </div>
            </div>

            <div>
                <ul className='text-gray-300 mx-10'> 
                    <li className='font-mono text-lg text-white font-bold mb-4'>Explore</li>
                    <li className='text-xs font-semibold mb-3'>Marketplace</li>
                    <li className='text-xs font-semibold mb-3'>Rankings</li>
                    <li className='text-xs font-semibold'>Connect a wallet</li>
                </ul>
            </div>

            <div>
                <h1 className='font-mono text-white pr-20 text-lg font-bold mb-3'>Join Our Weekly Digest </h1>
                <span className='text-gray-300 text-xs font-semibold'>Get exclusive promotions & updates <br /> straight to your inbox.</span>
                <form className='relative pt-4'>
                    <input placeholder='Enter your email here' className=' rounded-xl py-3 text-start pr-36 pl-4 text-xs' typeof="email"></input>
                    <button className=' bg-purple-600 text-white text-xs font-bold rounded-xl py-3 px-8 absolute -right-0.5 animate-scale'>Subscribe</button>
                </form> 
            </div>
        </div>
        <div className="mt-4 mx-28 border-b-2 border-gray-400 pb-4"></div>
        <p className="text-gray-300 text-xs ml-28 mt-2 pb-5">Ⓒ NFT Market</p>
